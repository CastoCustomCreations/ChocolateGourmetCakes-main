...
<h3>Category</h3>  
<p>Product type</p>
<input type="number" name="product_type" id="product_type" class="form-control" placeholder="1 Brownies,2 Cake,3 Cheesecake,4 Cookies,5 Cupcakes, 6 Muffins">
<br>
<p>Vendor / Brand</p>
<input type="number" name="brand" id="brand" class="form-control" placeholder="1 Homemade,2 Store Bought,3 Apple,4 motorolla">
<br>
<p>Other tags</p>
